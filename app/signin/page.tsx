...
export default function SignInPage() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    e.preventDefault(); // needed so form doesn't reset the page. 
    setIsLoading(true);
    setError(null);
    setMessage(null);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-linear from-blue-50 to-indigo-100 flex items-center justify-center py-12px-4sm:px-6 lg:px-8">
